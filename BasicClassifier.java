...
public void RunClassification(double threshold)throws IOException{
	...
	for (int k = 0; k < FOLDS; k ++){	
		...
		Classifier bayesSM = this.trainClassifierBayes(instancesSM);
		Classifier bayesST = this.trainClassifierBayes(instancesST);
		Classifier bayesRM = this.trainClassifierBayes(instancesRM);
		Classifier bayesRT  = this.trainClassifierBayes(instancesRT);
		Classifier bayesI = this.trainClassifierBayes(instancesI);
